...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/join_01.js":[function(require,module,exports) {
// [제이쿼리]wingbanner------------------------------------------
...
document.addEventListener('DOMContentLoaded', function () {
  var agreeTotal = document.querySelector('#agree_total');
  var agreeEl = document.querySelectorAll('.agree_chk');
  var agreeChk01 = document.querySelector('#agree_chk01');
  var agreeChk02 = document.querySelector('#agree_chk02');
  var agreeChk03 = document.querySelector('#agree_chk03');
  var btnNext = document.querySelector('.btn_next'); //다음페이지 이동
  var btnNextAttr = document.querySelector('.btn ul li .next_page'); //다음페이지 이동
  ...
  //전체동의or해제
  agreeTotal.addEventListener('click', function () {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/join_01.js"], null)
//# sourceMappingURL=/join_01.4b86a6d2.js.map